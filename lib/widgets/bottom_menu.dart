...
import 'package:apppmdfflutter/utils/gradient_icon.dart';
                    ...
                    return new ScaleTransition(
                      ...
                      child: widget.tabIconData.isSelected
                          ...
                          : GradientIcon(
                              ...
                              SgpolAppTheme.colorGradientSgpolWhite,
                            ),
                    );
                  }),
                ),
                  ...
                  child: ScaleTransition(
                    ...
                    scale: Tween<double>(begin: 0.0, end: 1.0).animate(
                        CurvedAnimation(
                            parent: widget.tabIconData.animationController,
                            curve:
                                Interval(0.2, 1.0, curve: Curves.decelerate))),
                    child: Container(
                      width: 8,
                      height: 8,
                      decoration: BoxDecoration(
                  ...
                  child: ScaleTransition(
                    ...
                    scale: Tween<double>(begin: 0.0, end: 1.0).animate(
                        CurvedAnimation(
                            parent: widget.tabIconData.animationController,
                            curve:
                                Interval(0.5, 0.8, curve: Curves.decelerate))),
                    child: Container(
                      width: 4,
                      height: 4,
                      decoration: BoxDecoration(
