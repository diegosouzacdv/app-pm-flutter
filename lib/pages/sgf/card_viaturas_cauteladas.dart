...
class CardViaturasCauteladas extends StatelessWidget {
  final AnimationController animationController;
  final Animation animation;

  const CardViaturasCauteladas(
                      ...
                      Positioned(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            splashColor: SgpolAppTheme.grey.withOpacity(0.1),
                            onTap: () {},
                            child: CustomPaint(
                              size: Size(80, 150),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Container(
                                    child: Text(
                                      'SGT Wallace Silva pereira junior ',
